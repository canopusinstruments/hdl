...
ad_ip_instance proc_sys_reset sys_300m_rstgen
ad_ip_parameter sys_300m_rstgen CONFIG.C_EXT_RST_WIDTH 1

# system reset/clock definitions

ad_connect  sys_cpu_clk sys_ps8/pl_clk0
ad_connect  sys_200m_clk sys_ps8/pl_clk1
ad_connect  sys_300m_clk sys_ps8/pl_clk2

ad_connect  sys_ps8/pl_resetn0 sys_rstgen/ext_reset_in
ad_connect  sys_cpu_clk sys_rstgen/slowest_sync_clk
ad_connect  sys_ps8/pl_resetn0 sys_200m_rstgen/ext_reset_in
ad_connect  sys_200m_clk sys_200m_rstgen/slowest_sync_clk
ad_connect  sys_ps8/pl_resetn0 sys_300m_rstgen/ext_reset_in
ad_connect  sys_300m_clk sys_300m_rstgen/slowest_sync_clk
...
ad_connect  sys_300m_reset sys_300m_rstgen/peripheral_reset
ad_connect  sys_300m_resetn sys_300m_rstgen/peripheral_aresetn

# generic system clocks&resets pointers

set sys_cpu_clk            [get_bd_nets sys_cpu_clk]
set sys_dma_clk            [get_bd_nets sys_200m_clk]
set sys_iodelay_clk        [get_bd_nets sys_300m_clk]
...
set  sys_iodelay_reset     [get_bd_nets sys_300m_reset]
set  sys_iodelay_resetn    [get_bd_nets sys_300m_resetn]
