...
set_property -dict {PACKAGE_PIN K17 IOSTANDARD LVCMOS18} [get_ports sdo[4]]       ; ##  Bank  67 VCCO - VADJ_FMC
set_property -dict {PACKAGE_PIN H19 IOSTANDARD LVCMOS18} [get_ports sdo[5]]       ; ##  Bank  67 VCCO - VADJ_FMC
set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS18} [get_ports sdo[6]]       ; ##  Bank  67 VCCO - VADJ_FMC
set_property -dict {PACKAGE_PIN L19 IOSTANDARD LVCMOS18} [get_ports sdo[7]]       ; ##  Bank  67 VCCO - VADJ_FMC
