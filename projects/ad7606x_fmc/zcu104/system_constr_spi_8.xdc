...
set_property -dict {PACKAGE_PIN G19 IOSTANDARD LVCMOS18} [get_ports ad7606_spi_sdi[1]]; ## C11 FMC_LPC_LA06_N
set_property -dict {PACKAGE_PIN K17 IOSTANDARD LVCMOS18} [get_ports ad7606_spi_sdi[2]]; ## D11 FMC_LPC_LA05_P
set_property -dict {PACKAGE_PIN H16 IOSTANDARD LVCMOS18} [get_ports ad7606_spi_sdi[3]]; ## D14 FMC_LPC_LA09_P
set_property -dict {PACKAGE_PIN K18 IOSTANDARD LVCMOS18} [get_ports ad7606_spi_sdi[4]]; ## G10 FMC_LPC_LA03_N
set_property -dict {PACKAGE_PIN L16 IOSTANDARD LVCMOS18} [get_ports ad7606_spi_sdi[5]]; ## H11 FMC_LPC_LA04_N
set_property -dict {PACKAGE_PIN J15 IOSTANDARD LVCMOS18} [get_ports ad7606_spi_sdi[6]]; ## H14 FMC_LPC_LA07_N
set_property -dict {PACKAGE_PIN E17 IOSTANDARD LVCMOS18} [get_ports ad7606_spi_sdi[7]]; ## G13 FMC_LPC_LA08_N
